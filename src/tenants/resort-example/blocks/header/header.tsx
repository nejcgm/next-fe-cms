    ...
    <header className="bg-[var(--color-background)] border-b border-[var(--color-border)] sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
                ...
                <a
                  ...
                  className={cn(
                    ...
                    active
                      ...
                      : "text-[var(--color-text-primary)] hover:text-[var(--color-primary)] hover:bg-[var(--color-muted)]"
                  )}
          ...
          {/* Mobile menu button */}
          <button
            className="md:hidden p-2 rounded-md text-[var(--color-text-primary)] hover:bg-[var(--color-muted)]"
